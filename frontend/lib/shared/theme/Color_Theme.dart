...
abstract final class PracticePalette {
  ...
  /// The middle mood band — played, not clean. Warm amber so it reads as
  /// "keep going" rather than as either praise or a fault.
  static const Color caution = Color(0xFFB1844D);
