...
def enhance_page(input_pdf_path: str, page_num: int) -> Image:
    ...
    blur = gray.gaussblur(15) # type: ignore
    ...
    return dilated.morph(mask_matrix, "erode")
...
def enhance_music_pdf(input_pdf_path: str, output_pdf_path: str):
    ...
    try:
        ...
        for p in range(n_pages):
            ...
            page.write_to_file(page_output_path, page_height=meta[0].height) 
        return True
